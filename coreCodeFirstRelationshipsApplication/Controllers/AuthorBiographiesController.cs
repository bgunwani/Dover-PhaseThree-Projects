...
namespace coreCodeFirstRelationshipsApplication.Controllers
{
    public class AuthorBiographiesController : Controller
    {
        private readonly ApplicationDBContext _context;

        public AuthorBiographiesController()
        {
        ...
        public async Task<IActionResult> Create([Bind("AuthorBiographyId,DateOfBirth,PlaceOfBirth,Nationality,Country,AuthorId")] AuthorBiography authorBiography)
        {
            ...
            ViewData["AuthorId"] = new SelectList(_context.Authors, "AuthorId", "FirstName", authorBiography.AuthorId);
            return View(authorBiography);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AuthorBiographyId,DateOfBirth,PlaceOfBirth,Nationality,Country,AuthorId")] AuthorBiography authorBiography)
        {
